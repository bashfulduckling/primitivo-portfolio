...
function $e91ef4e5004e3774$export$52994e973806c219(props, state, ref) {
  ...
  (0, import_react4.useEffect)(() => {
    if (prevResizingColumn.current !== resizingColumn && resizingColumn != null && resizingColumn === item.key) {
      wasFocusedOnResizeStart.current = (0, $d4ee10de306f2510$export$cd4e5573fbe2b576)() === ref.current;
  ...
  let onChange = (e2) => {
    ...
    let nextValue = parseFloat((0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e2).value);
...
function Keystatic(props) {
  ...
  const Wrapper = props.config.storage.kind === "local" ? import_react8.Fragment : RedirectToLoopback;
  let t0;
  if ($[0] !== props.config) {
...
*/
//# sourceMappingURL=chunk-V4SESTRR.js.map
